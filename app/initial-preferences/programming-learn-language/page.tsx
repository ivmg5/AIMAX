...
export default function ProgrammingLearnLanguage() {
    ...
    useEffect(() => {
        ...
        if (savedOptions) {
            try {
                ...
                localStorage.removeItem("programmingLearnLanguages");
            }
        }
    }, []);
    ...
    const saveSelection = () => {
        const allSelectedOptions = otherLanguage.trim()
            ? [...selectedOptions, otherLanguage.trim()]
            : selectedOptions;

        try {
            const jsonString = JSON.stringify(allSelectedOptions);
            localStorage.setItem("programmingLearnLanguages", jsonString);
