...
- **AUTH_SECRET**: Generate using the command below:
...
Log in to PostgreSQL and create the database and user by running the following SQL commands:
...
- **Database Migration**:  
   After any changes to the Prisma schema, run:
